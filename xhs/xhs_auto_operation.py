...
XHS_CLIENT_PATH = Path.home() / ".openclaw/workspace/skills/xiaohongshu-mcp-1.0.0/scripts/xhs_client.py"
VENV_PATH = Path("/Users/huzezhi/Documents/test/Script/SaturnScript/npi-test/2025/.venv")
    ...
    for keyword in trending_keywords[:CONFIG["trending_topics_count"]]:
        try:
            ...
            result = subprocess.run(
                ...
                env={**os.environ, 'PYTHONPATH': str(VENV_PATH / 'lib/python3.9/site-packages')}
            )
